...
def info():
    ...
    resq_data['info'] = member_info
    return ops_render("member/info.html",resq_data)
...
def set():
    ...
    member_info = Member.query.filter_by(id=id).first()
    resq_data['info'] = member_info
    return ops_render("member/set.html",resq_data)
...
@router_member.route("remove-recover",methods=['GET','POST'])
def removeOrRecover():
    resp = {
        'code':200,
        'msg':"操作成功",
